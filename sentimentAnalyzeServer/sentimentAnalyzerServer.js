...
function getNLUInstance() {
    ...
    const naturalLanguageUnderstanding = new NaturalLanguageUnderstandingV1({
        ...
        authenticator: new IamAuthenticator({
            apikey: '6IvKqh45DIfgoQbv0iPQQrT7tYAlputZ3MmxqTJrQJ1S',
        }),
        serviceUrl: 'https://api.eu-gb.natural-language-understanding.watson.cloud.ibm.com/instances/8a6850e5-11f5-4824-a0a7-1be505c1dc1e'
    });
